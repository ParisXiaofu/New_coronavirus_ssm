...
<script>
    ...
    $(function () {
        ...
        $("#confirm").click(function () {
            ...
            var userpwd1=$("#pwd2").val()
            if (username.length=0||useremail.length==0||userpwd.length==0||userpwd1.length==0){
                alert("输入框不允许为空！")
            } else {
                var china=/^[\u4E00-\u9FA5]$/
                if (china.test(username)||username.length>4){
                    alert("名字必须为中文,且长度必须小于4")
                }
                else {
                    if (userpwd1==userpwd){
                        if ($("#chb3").prop("checked")==true &&$("#chb4").prop("checked")==true){
                            $.ajax({
                                type:"post",
                                url:"getuser.form",
                                ...
                                success:function (data) {
                                   if (data=="success"){
                                       ...
                                       $.ajax({
                                           type:"POST",
                                           url:"registered.form",
                                           data:{"username":username,"useremail":useremail,"userpwd":userpwd1},
                                           success:function (data) {
                                               var con=confirm("注册成功！\n是否直接登录?");
                                               if (con==true){
                ...
                <div class="login-form">
                    <div class="user-form">
                        <div class="section-heading text-center">
                            <h5 class="section__meta">注册账户</h5>
                            <h2 class="section__title font-size-30">创建您的账户</h2>
                            ...
                            <form method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="text" placeholder="姓名" id="name">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <div class="form-group">
                                                <input class="form-control" type="email" name="email" placeholder="电子邮件地址" id="email">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <div class="form-group">
                                                <input class="form-control" type="password" name="text" placeholder="密码" id="pwd1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <div class="form-group">
                                                <input class="form-control" type="password" name="text" placeholder="确认密码" id="pwd2">
                                                <span class="la la-lock input-icon"></span>
                                            </div><!-- end form-group -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-box">
                                            <div class="form-group">
                                                <div class="custom-checkbox d-block mr-0">
                                                    ...
                                                    <label for="chb3">我同意科斯特的 <a href="#" class="color-text">隐私政策</a></label>
                                                </div><!-- end custom-checkbox -->
                                                <div class="custom-checkbox d-block mr-0">
                                                    <input type="checkbox" id="chb4" >
                                                    <label for="chb4">我同意科斯特的 <a href="#" class="color-text">服务条款</a></label>
                                                </div><!-- end custom-checkbox -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="btn-box">
                                            <div class="form-group text-center mb-0">
                                                <button class="template-btn border-0 w-100" type="button" id="confirm">创建我的账户</button>
                                            </div><!-- end form-group -->
                                        </div>
                                    </div>
                                </div><!-- end row -->
