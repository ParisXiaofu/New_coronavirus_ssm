...
<%@ page import="com.flh.model.entity.Sarsways" %>
<!DOCTYPE html>
...
<script>
    $(function () {
        $("#goto").click(function () {
            ...
            if (userpwd1.length==0||userpwd2.length==0){
                alert("输入框不能为空！");
            } else {
                if (userpwd2!=userpwd1){
                    ...
                    $.ajax({
                        type:"POST",
                        url:"updatePwd.form",
                        data:{"userpwd":userpwd2},
                        success:function (data) {
                            if (data=="success"){
                            var con=confirm("密码重置成功！\n是否直接登录?");
                            if (con==true){
                ...
                <div class="row align-items-center h-100">
                    ...
                    <div class="col-lg-9">
                        <div class="menu-wrapper">
                            <nav class="main-menu">
                                <span style="font-size: 20px;color: whitesmoke">如果遇到问题请联系我们</span>
                            </nav><!-- end main-menu -->
                            <div class="logo-right-button logo-right-button-2">
                                <ul>
                                    <li><a href="contact.jsp" class="template-btn">联系我们</a></li>
                                </ul>
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title">重置密码</h2>
                    </div>
...
<section class="slider-area banner-area-2 text-center" >
    <div class="single-slide-item banner-item-3" style="height: 490px">
        <div id="particles-bg-2">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                                    ...
                                                    <form method="post">
                                                        <div class="input-box">
                                                            <div class="form-group">
                                                                <input class="form-control" type="password" name="email" placeholder="输入新密码" id="pwd1">
                                                                <span class="la la-lock input-icon"></span>
                                                            </div><!-- end form-group -->
                                                            <div class="form-group">
                                                                <input class="form-control" type="password" name="email" placeholder="确认新密码" id="pwd2">
                                                                <span class="la la-lock input-icon"></span>
                                                            </div><!-- end form-group -->
                                                        </div>
                                                        <div class="input-box">
                                                            <div class="form-group" style="text-align: center">
                                                                <button class="template-btn border-0" type="button" id="goto">确认修改</button>
                                                            </div><!-- end form-group -->
