        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $(data.blogList1).each(function () {
                    result+=" <div class=\"col-lg-4 column-td-6\">\n" +
                        "                <div class=\"card-item\">\n" +
                        ...
                        "                        <h3 class=\"card-title\"><a href=\"blog-single.jsp\">"+this.blogtopic+"</a></h3>\n" +
                        "                        <ul class=\"list-items\">\n" +
                        "                            <li class=\"card-dot-active\"><span class=\"la la-user\"></span><a href=\"#\">"+this.doctor.doctorname+"</a></li><br>\n" +
...
<section class="blog-area padding-top-140px padding-bottom-120px">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-navigation-wrap mt-4" id="blogindex">
