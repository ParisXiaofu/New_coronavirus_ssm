            ...
            success:function (data) {
                ...
                $(data).each(function (i) {
                    result+="<div class=\"card\">\n" +
                        "                            <div class=\"card-header\" id=\"heading"+this.questionid+"\">\n" +
                        "                                <h2>\n" +
                        "                                    <button class=\"btn btn-link collapsed\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapse"+this.questionid+"\"\n" +
                        "                                            aria-expanded=\"false\" aria-controls=\"collapse"+this.questionid+"\">\n" +
                        "                                      "+this.questioninfo+"\n" +
                        "                                    </button>\n" +
                        "                                </h2>\n" +
                        "                            </div>\n" +
                        "                            <div id=\"collapse"+this.questionid+"\" class=\"collapse\" aria-labelledby=\"heading"+this.questionid+"\" data-parent=\"#accordionExample\">\n" +
                        "                                <div class=\"card-body\">\n" +
                        "                                   "+this.questionreplyinfo+"\n" +
                        "                                </div>\n" +
                        "                            </div>\n" +
                        "                        </div><!-- end card -->";
                    if (i>=5){
                ...
                $("#accordionExample").html(result);
                if (${empty sarswaysList}) {
                    location.href="sarsWays.form"
                }
            }
        })
    })
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title">常见问题 解答</h2>
                    </div>
...
======================================-->
<section class="accordion-area padding-top-140px padding-bottom-120px">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h5 class="section__meta">常见问题</h5>
                    <h2 class="section__title padding-bottom-15px">寻找答案？</h2>
            ...
            <div class="col-lg-5">
                <div class="user-form">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title font-size-20 font-weight-medium">还有问题吗？联系我们！</h2>
                    </div><!-- end section-heading -->
                    <div class="contact-form-action mt-4">
                        <form method="POST" name="contactform" action="php/contact.php">
                            ...
                            <div class="input-box">
                                <div class="form-group">
                                    <textarea class="message-control form-control" name="message" id="question" placeholder="在这里写下你的地址"></textarea>
                                    <span class="la la-pencil input-icon"></span>
                                </div><!-- end form-group -->
                            </div>
                            <div class="btn-box">
                                <div class="form-group text-center mb-0">
                                    <button class="template-btn border-0 w-100" id="goto" type="button">提交问题</button>
                                </div><!-- end form-group -->
                            </div>
                        </form>
