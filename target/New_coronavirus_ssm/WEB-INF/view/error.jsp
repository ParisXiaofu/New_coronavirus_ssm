                    ...
                    <div class="col-lg-9">
                        <div class="menu-wrapper">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            ...
                                            <li><a href="../../doctor-single.jsp">Doctor detail</a></li>
                                            <li><a href="../../contact.jsp">Contact us</a></li>
                                            <li><a href="../../faq.jsp">Faqs</a></li>
                                            <li><a href="error.jsp">Error page</a></li>
                                            <li><a href="../../recover.jsp">Recover pass</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            ...
                                            <li><a href="../../blog-single.jsp">blog detail</a></li>
                                        </ul>
                                    </li>
                                    <li>
                            ...
                            <div class="logo-right-button logo-right-button-2">
                                <ul>
                                    <li><a href="../../prevention.jsp" class="template-btn">Prevention</a></li>
                                </ul>
                                    ...
                                    <ul class="side-menu-ul">
                                        <li class="sidenav__item">
                                            ...
                                            <ul class="side-sub-menu">
                                                ...
                                                <li><a href="../../index.jsp">Home 03</a></li>
                                            </ul>
                                        </li>
                                        <li class="sidenav__item"><a href="../../about.jsp">about</a></li>
                                        <li class="sidenav__item">
                                            <a href="#">pages</a>
                                            <span class="menu-plus-icon"></span>
                                            <ul class="side-sub-menu">
                                        ...
                                        <li class="sidenav__item"><a href="../../prevention.jsp">Prevention</a></li>
                                        <li class="sidenav__item">
                                            <a href="../../blog-grid.jsp">blog</a>
                                            <span class="menu-plus-icon"></span>
                                            <ul class="side-sub-menu">
                                                <li><a href="../../blog-grid.jsp">blog grid</a></li>
                                                <li><a href="../../blog-sidebar.jsp">blog sidebar</a></li>
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title">404 Page</h2>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copyright-content text-center">
                    <p class="copy__desc">Copyright &copy; 2020.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
                </div>
            </div><!-- end col-lg-12 -->
